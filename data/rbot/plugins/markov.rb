  ...
  def random_markov(m, message)
    begin
      ...
      if words.length < 2
        ...
        pat = case
              when Regexp.union(/^do/i,/^will/i,/^how/i, /^what/i, /^should/i).match(w_o)
                QPATTERN
